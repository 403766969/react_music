  ...
  return (
    <StyledWrapper className="page-search">
      <div className="content wrap-v3">
        <SearchInput keywords={keywords} type={type} />
        {
          keywords && (
            <SearchMessage
              keywords={keywords}
        ...
        }
        {
          keywords && (
            <TabsArea activeKey={type} onTabClick={handleTabClick}>
              <div tab="单曲" key="song">
                <ResultSong songList={r_songList} songCount={r_songCount} keywords={keywords} keywordsMatcher={keywordsMatcher} />
              </div>
              <div tab="歌单" key="songsheet">
                <ResultSongsheet songsheetList={r_songsheetList} songsheetCount={r_songsheetCount} keywords={keywords} keywordsMatcher={keywordsMatcher} />
              </div>
              <div tab="歌手" key="artist">
                <ResultArtist artistList={r_artistList} artistCount={r_artistCount} keywords={keywords} keywordsMatcher={keywordsMatcher} />
              </div>
            </TabsArea>
          )
        }
